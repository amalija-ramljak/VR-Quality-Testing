namespace VRQualityTesting.Scripts.PickAndPlaceMenu
{
    public static class PickAndPlaceKeys
    {
        ...
        public const string MinTranslation = Prefix + "MinTranslation";
        public const string MaxTranslation = Prefix + "MaxTranslation";
        public const string MinRotation = Prefix + "MinRotation";
        public const string MaxRotation = Prefix + "MaxRotation";
